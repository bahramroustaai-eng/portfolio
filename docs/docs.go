    ...
    "paths": {
        ...
        "/items": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/transport.ItemResponse"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "investment item payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/transport.CreateItemRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "transport.CreateItemRequest": {
            ...
            "properties": {
                ...
                "risk_level": {
                    "$ref": "#/definitions/portfo.RiskLevel"
                },
                "ticker": {
                    "type": "string"
                },
